...
public class MoveObject : MonoBehaviour
{
    ...
    public bool isMoving = true, hasFinished = false;
    ...
    void Update()
    {
        ...
        if (isMoving)
        {
            ...
            if (!smoothLook)
            {
                moveObj.transform.position = toObj.transform.position + positionOffSet.x * transform.right + positionOffSet.y * transform.up + positionOffSet.z * transform.forward;
